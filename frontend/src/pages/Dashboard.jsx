      ...
      <main className="max-w-4xl mx-auto px-4 py-10 sm:py-12 print:py-4">
        ...
        {loading && !result ? (
          <div className="flex flex-col items-center justify-center py-16 sm:py-20 animate-in fade-in duration-500">
            <div className="relative w-64 h-80 bg-white border border-gray-200 rounded-3xl shadow-2xl overflow-hidden flex flex-col items-center pt-8">
              {/* Fake PDF Content */}
        ...
        !result ? (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-lime-100 text-lime-800 border border-lime-200 font-bold text-xs sm:text-sm mb-5 shadow-xs">
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/60 border border-gray-100 p-6 sm:p-8 md:p-10">
              {prefilledFromTools && (
              ...
              <form onSubmit={handleScan} className="space-y-6 sm:space-y-8">
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full px-5 py-4 rounded-2xl border border-gray-200 bg-gray-50/50 text-gray-900 placeholder:text-gray-400 focus:bg-white focus:ring-4 focus:ring-lime-500/20 focus:border-lime-500 outline-none resize-none transition-all shadow-xs text-sm sm:text-base" 
                ...
                <div>
                  ...
                  <div className={`relative border-2 border-dashed rounded-2xl p-8 sm:p-10 text-center transition-all cursor-pointer group ${resumeFile ? 'border-lime-500 bg-lime-50/50' : 'border-gray-300 bg-gray-50/50 hover:border-lime-500 hover:bg-lime-50/20'}`}>
                    ...
                    <div className="flex flex-col items-center gap-3">
                      <div className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-105 shadow-sm ${resumeFile ? 'bg-lime-500 text-gray-950 shadow-lime-500/30' : 'bg-white text-lime-600 border border-gray-200'}`}>
        ...
        (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
             <div id="premium-report-content" className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden print:shadow-none print:border-0 relative">
                 ...
                 <div className="p-8 md:p-12 text-center border-b border-gray-100 bg-gradient-to-b from-gray-50/80 to-white">
                ...
                <div className="mt-6 flex justify-center px-4">
                  <button
                    ...
                    className={`px-6 py-3 rounded-full font-bold text-sm transition-all duration-300 shadow-sm flex items-center gap-2 ${
                      isSharedToWall 
                        ...
                        : 'bg-indigo-50 text-indigo-700 hover:bg-indigo-100 hover:shadow-md border border-indigo-200'
                    }`}
                  >
                    {isSharedToWall ? (
                      <>
                 ...
                 <div className={`p-6 sm:p-8 md:p-12 ${!isUnlocked ? 'blur-md select-none opacity-40 pointer-events-none' : ''} transition-all duration-700`}>
                    ...
                    <div className="mb-12">
                      ...
                      <div className="flex flex-wrap gap-2.5 sm:gap-3">
                          {result.missing_keywords?.map((word, index) => (
                              <span key={index} className="px-4 py-2 bg-amber-50 border border-amber-200 rounded-xl text-sm font-bold text-amber-900 shadow-xs">{word}</span>
                          ))}
                      </div>
                    </div>
                    ...
                    <div className="mb-12">
                      ...
                      <div className="bg-blue-50/70 p-6 rounded-2xl border border-blue-200/80">
                    ...
                    <div className="pt-8 border-t border-gray-100">
                        ...
                        <div className="space-y-4 mb-12">
                            {result.rewritten_bullets?.map((bullet, i) => (
                                <div key={i} className="p-6 bg-lime-50/70 rounded-2xl border border-lime-200 flex gap-4 items-start shadow-xs">
                        ...
                        <div className="p-6 sm:p-8 bg-gray-50 rounded-2xl border border-gray-200 text-gray-900 whitespace-pre-wrap font-serif leading-loose text-base sm:text-lg shadow-inner">
                            {result.cover_letter}
                        </div>
                    </div>
                 </div>
             ...
             {!isUnlocked ? (
                 <div className="fixed bottom-0 left-0 right-0 z-50 flex flex-col items-center justify-center bg-white/95 backdrop-blur-xl border-t border-gray-200 p-4 sm:p-6 text-center shadow-[0_-20px_40px_rgba(0,0,0,0.08)] print:hidden">
                    <div className="w-12 h-1 bg-gray-300 rounded-full mb-4 sm:hidden"></div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full max-w-xl">
                        {!isDiscounted ? (
                            <button 
                                type="button"
                                onClick={handleShare} 
                                className="flex-1 bg-[#25D366] hover:bg-[#20bd5a] text-white px-5 py-3.5 sm:py-4 rounded-2xl font-bold text-base sm:text-lg transition-all flex items-center justify-center gap-2 shadow-xl shadow-[#25D366]/20 active:scale-95 cursor-pointer"
                            >
                                <MessageCircle size={22} /> Share for 50% Off
                            </button>
                        ) : (
                            <div className="flex-1 bg-green-50 border-2 border-green-200 text-green-800 px-5 py-3.5 sm:py-4 rounded-2xl font-bold text-base sm:text-lg flex items-center justify-center gap-2">
                        ...
                        <button 
                            ...
                            disabled={loading}
                            className="flex-1 bg-gray-900 hover:bg-black text-white px-5 py-3.5 sm:py-4 rounded-2xl font-bold text-base sm:text-lg shadow-xl shadow-gray-900/20 transition-all flex items-center justify-center gap-2 disabled:opacity-70 active:scale-95 cursor-pointer"
                        >
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6 print:hidden">
                    <button 
                        type="button"
                        onClick={downloadPDF} 
                        className="flex-1 flex items-center justify-center gap-2 bg-lime-500 hover:bg-lime-600 text-gray-950 py-4 rounded-2xl font-bold text-lg transition-all shadow-xl shadow-lime-500/20 active:scale-95 cursor-pointer"
                    >
