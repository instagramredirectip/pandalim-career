...
export function getPseoData(slug) {
  ...
  if (slug.includes('-at-')) {
    ...
    if (role && company) {
      return {
        ...
        description: `Free AI resume scanner for ${role.title} jobs at ${company.name}. Scan against ${company.name} ATS filters, find missing keywords, and get hired.`,
  ...
  if (role) {
    return {
      ...
      salaryIndia: role.avgSalaryIndia,
      salaryGlobal: role.avgSalaryGlobal,
      description: `Free AI ATS resume scanner for ${role.plural}. Scan against target job postings, discover missing keywords, and land more tech interviews.`,
      topKeywords: role.topKeywords,
      overview: role.overview,
      atsTips: role.atsTips,
  ...
  return {
    ...
    description: `Free AI ATS resume scanner for ${formatted} roles. Scan your resume against job postings, find missing keywords, and land more interviews.`,
    topKeywords: [
